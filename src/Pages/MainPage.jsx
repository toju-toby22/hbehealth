...
const MainPage = () => {
  ...
  const handleContactSubmit = (e) => {
    ...
    const subject = encodeURIComponent(
      "New contact request from HB eHealth website",
    );
    const bodyLines = [
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav
        className={`fixed w-full bg-white text-amber-50 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-lg" : "bg-transparent"}`}
      >
                  ...
                  return (
                    <div key={item}>
                      ...
                      >
                        <span>Products</span>
                        <ChevronDown
                          className={`w-4 h-4 ${isMobileProductsOpen ? "rotate-180" : ""}`}
                        />
                      </button>
      ...
      <section
        id="home"
        className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-900"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-white  mb-12 max-w-3xl mx-auto leading-relaxed">
              Digital health solutions connecting people, providers, and data
              for better health outcomes across Africa
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                A digital health company dedicated to transforming healthcare
                delivery in Africa through innovative, technology-driven
                solutions.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                We design and implement intelligent digital health products,
                telemedicine platforms, and smart health infrastructure aimed at
                improving access, efficiency, and quality of care across the
                continent.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                By integrating technology, insight, and collaboration, we bridge
                critical gaps in healthcare systems, empowering providers and
                enhancing patient outcomes through smart, reliable, and scalable
                digital solutions.
              </p>
            </div>
      ...
      <section
        id="vision"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-teal-600 to-cyan-700 text-white"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/10 flex-col items-center justify-center backdrop-blur-lg p-10 rounded-3xl hover:bg-white/20 transition-all">
              ...
              <p className="text-xl mb-6 leading-relaxed">
                To redefine healthcare in Africa by building intelligent digital
                systems that connect people, providers, and data for better
                health.
              </p>
            </div>
            ...
            <div className="bg-white/10 flex-col items-center justify-center backdrop-blur-lg p-10 rounded-3xl hover:bg-white/20 transition-all">
              ...
              <p className="text-xl mb-6 leading-relaxed">
               To design and deploy innovative digital health products that improve access to quality healthcare, strengthen health systems, support data-driven decision-making and connect individuals, providers, institutions and payers across the healthcare value chain
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="products" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              HB eHealth develops and deploys customized Hospital Management
              System (HMS) and Electronic Medical Record (EMR) platforms to
              transform healthcare delivery in Africa.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our flagship solution that consolidates clinical, operational,
                and financial information into a unified digital ecosystem,
                revolutionizing healthcare management.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                By automating daily operations and digitizing critical
                processes, we help healthcare facilities in Africa improve
                efficiency, accuracy, and overall service quality.
              </p>
        ...
        <img
          src={bridge}
          alt="Bridge"
          className="mx-auto w-full max-w-3xl h-auto md:h-[400px] object-contain rounded-2xl shadow-lg mb-15"
        />
      ...
      <section
        id="idis2go"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-teal-50 to-cyan-50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              Extending healthcare access to underserved populations through
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-6 mt-8 ">
                  IDIS2GO: Portable TeleHealth System
                </h3>
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  A comprehensive IoT and cloud powered by{" "}
                  <span>
                    <a
                      className="text-blue-600 underline"
                      href="https://www.sk-telemed.co.at/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      SK-Telemed GmbH — Healthcare & Medical IT/Software Company
                    </a>
                  </span>{" "}
                  which enables remote collection and transmission of patient
                  data.
                </p>
              ...
              <div className="">
                <h4 className="text-2xl font-bold text-gray-900 mb-6">
                  How IDIS2GO Extends Healthcare Access
                </h4>
                ...
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 pb-4">
                    <div
                      className={`w-12 h-12 bg-linear-to-br ${step.color} rounded-xl flex items-center justify-center shrink-0`}
                    >
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              HBI’s Smart Telehealth Booth brings high-quality healthcare closer
              to you. Each walk-in booth is equipped with the advanced IDIS2GO
              diagnostic system, connecting you instantly to doctors via the
              BridgeCare platform. Whether you use the BridgeCare App from home
              for a consultation or visit a booth for a check-up with an onsite
              assistant, getting care is simple and fast. We offer three
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-linear-to-br from-cyan-600 to-teal-700 p-10 rounded-3xl text-white text-center md:col-span-2 max-w-md mx-auto">
              ...
              <p className="text-cyan-100 text-lg leading-relaxed">
                Diagnostics and consultation with a direct referral to a
                hospital if you need further treatment.
              </p>
            </div>
          </div>
      ...
      <section
        id="capacity"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-gray-50 to-teal-50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div className="bg-white p-10 rounded-3xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Training health workers to effectively use eHealth tools,
                empowering healthcare professionals to adopt new digital
                technologies.
              </p>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Using data and technology to make healthcare delivery more
                efficient, connected, and patient-centered across Africa.
              </p>
          ...
          <div className="bg-linear-to-r from-teal-600 to-cyan-600 p-8 rounded-2xl text-center">
            <p className="text-xl font-semibold text-white">
              Integrated approach: Building digital capacity and strengthening
              systems for sustainable healthcare transformation
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-teal-100 max-w-4xl mx-auto leading-relaxed">
              HB eHealth is dedicated to forging a healthier future for Africa
              by leveraging smart, reliable, and scalable digital solutions. We
              remain steadfast in our vision to redefine healthcare by building
              intelligent digital systems that seamlessly connect people,
              providers, and data, ultimately enhancing health outcomes across
              the continent.
            </p>
          </div>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Ready to transform healthcare delivery? Let's connect and explore
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex flex-col items-start gap-6">
                <a
                  href="mailto:info@hbehealth.com"
                ...
                <a
                  href="https://linkedin.com/company/hb-ehealth"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-gray-400 hover:text-teal-400 transition-colors"
                >
                ...
                <div className="flex gap-2 text-gray-400">
                  ...
                  <p className="text-left">
                    Plot 467, Joseph E. Adetoro Street, Utako,Abuja,Nigeria
                  </p>
                </div>
              </div>
            </div>
